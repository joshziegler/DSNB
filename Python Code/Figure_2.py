...
age, calibsp1, calibsp2, calibsp3, calibsp4, calibsp5 = np.loadtxt(
    "../Data/Calibration/SFcalibration_spiral.dat", unpack=True, skiprows=1
)
age, calibsb1, calibsb2, calibsb3, calibsb4, calibsb5 = np.loadtxt(
    "../Data/Calibration/SFcalibration_starburst.dat", unpack=True, skiprows=1
)
...
plt.ylabel(r"FIR Calibration $[\mathrm{M_{\odot}\,yr^{-1}\,erg^{-1}\,s}]$")
plt.legend(fontsize=14, ncol=1, loc="upper right", frameon=True)
plt.savefig("../plots/Calib_alpha.pdf", bbox_inches="tight")

age, calibspa, calibspb, calibspc, calibspd = np.loadtxt(
    "../Data/Calibration/SFcalibration_spiral_2.35.dat", unpack=True, skiprows=1
)
age, calibsba, calibsbb, calibsbc, calibsbd = np.loadtxt(
    "../Data/Calibration/SFcalibration_starburst_2.35.dat", unpack=True, skiprows=1
)
plt.figure(figsize=(7, 5))
...
plt.semilogx(age, calibsbd, ls="--", color="C3")
...
plt.xlabel(r"Time Since Start of Star Formation [Myr]")
plt.ylabel(r"FIR Calibration $[\mathrm{M_{\odot}\,yr^{-1}\,erg^{-1}\,s}]$")
plt.legend(fontsize=14, ncol=3, loc="lower left", frameon=True)
